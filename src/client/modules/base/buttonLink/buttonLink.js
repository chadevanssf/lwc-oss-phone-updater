/*
 * Built directly from cButton, modified to use <a> instead of <button>
 * and supporting href and target
 */
...
export default class cButtonLink extends cPrimitiveButton {
